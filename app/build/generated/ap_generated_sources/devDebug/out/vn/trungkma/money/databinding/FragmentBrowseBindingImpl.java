...
public class FragmentBrowseBindingImpl extends FragmentBrowseBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_browse_back, 1);
        sViewsWithIds.put(R.id.tv_broser, 2);
        sViewsWithIds.put(R.id.img_browse_add, 3);
        sViewsWithIds.put(R.id.scroll_browse_folder, 4);
        sViewsWithIds.put(R.id.recycler_browse, 5);
        sViewsWithIds.put(R.id.btn_browse_paste, 6);
    }
    // views
    @NonNull
