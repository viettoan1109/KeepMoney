...
public class FragmentMusicBindingImpl extends FragmentMusicBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_music_back, 1);
        sViewsWithIds.put(R.id.tv_music, 2);
        sViewsWithIds.put(R.id.img_music_search, 3);
        sViewsWithIds.put(R.id.tv_music_cancel, 4);
        sViewsWithIds.put(R.id.search_music, 5);
        sViewsWithIds.put(R.id.tv_music_noData, 6);
        sViewsWithIds.put(R.id.rl_music_ads, 7);
        sViewsWithIds.put(R.id.progress_music, 8);
        sViewsWithIds.put(R.id.recycler_music, 9);
    }
    // views
    @NonNull
